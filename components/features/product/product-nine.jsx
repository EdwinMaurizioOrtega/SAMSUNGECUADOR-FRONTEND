...
function ProductOne ( props ) {
    const { product, adClass, toggleWishlist, wishlist, addToCart, openQuickview, isCategory = true, isRating = true, isStockCount = false } = props;
    ...
    return (
        <div className={ `product ${ adClass }` }>
            ...
            <div className="product-details">
                { isCategory && <div className="product-cat">
                    {
                        product.categories ?
                ...
                { isRating && <div className="ratings-container">
                ...
                {/*{ isStockCount &&*/}
                {/*    <div className="count-text">Only <strong>{ product.stock }</strong> Left</div>*/}
                {/*}*/}
            </div>
        </div>
    )
