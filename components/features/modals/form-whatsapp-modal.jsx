...
function FormWhatsAppModal ({product}) {
    ...
    const handleSubmit = (event) => {
        ...
        const whatsappUrl = `https://api.whatsapp.com/send?phone=593939991111&text=Producto: *${product.data.name}*%0ANombre: ${nombre}%0ACédula: ${cedula}%0AEmail: ${email}%0ATeléfono: ${telefono}%0ADirección: ${direccion}%0ACiudad: ${ciudad}`;
    ...
    const handleSubmitAux = (event) => {
        ...
        const whatsappUrl = `https://api.whatsapp.com/send?phone=593939991111&text=Hola, estoy interesado/a en este producto: ${product.data.name}, Precio promocional: $${product.data.sale_price}, Precio PVP: $${product.data.price}`;
        window.open(whatsappUrl, '_blank');
