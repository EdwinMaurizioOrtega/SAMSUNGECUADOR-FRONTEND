                ...
                <div className="col-md-6 p-relative mb-4 mb-md-0">
...

                    {
                        product.price[ 0 ] !== product.price[ 1 ] && product.until ?
                            <Countdown type={ 3 } adClass="d-flex align-items-center font-weight-semi-bolold text-white x-50 w-100 justify-content-center flex-wrap" /> : ''
                    }
                </div>
                                            ...
                                            <div className='product-form product-size mb-0 pb-2'>
                                                ...
                                                <div className="product-form-group">
                                                    <div className="product-variations">
                                                        {
                                                            sizes.map( item =>
                                                                <ALink href="#" className={ `size ${ curSize === item.name ? 'active' : '' } ${ isDisabled( curColor, item.name ) ? 'disabled' : '' }` } key={ "size-" + item.name } onClick={ ( e ) => toggleSizeHandler( item ) }>{ item.name }</ALink> )
                                                        }
                                                    </div>
                                                </div>
                                            </div> : ''
                                            ...
                                            <div className='product-form product-color'>
                                                ...
                                                <div className="product-form-group">
                                                    <div className="product-variations">
                                                        {
                                                            colors.map( item =>
                                                                <ALink href="#" className={ `size ${ curColor === item.name ? 'active' : '' } ${ isDisabled( item.name, curSize ) ? 'disabled' : '' }` } key={ "color-" + item.name } onClick={ ( e ) => toggleColorHandler( item ) }>{ item.name }</ALink> )
                                                        }
                                                    </div>
