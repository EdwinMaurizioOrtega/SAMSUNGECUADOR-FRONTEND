    ...
    return (
        <Tabs className="tab tab-nav-simple product-tabs" selectedTabClassName="show" selectedTabPanelClassName="active" defaultIndex={ 0 } >
            <TabList className="nav nav-tabs justify-content-center" role="tablist">
                ...
                {
                    product && product.categories.length > 0 || product.brands.length > 0 || colors.length > 0 || sizes.length > 0 ?
                        <Tab className="nav-item">
                            <span className="nav-link">Información Adicional</span>
                        </Tab> : ''
                }
                {/*{*/}
                {/*    isGuide ?*/}
            ...
            <div className="tab-content">
                <TabPanel className="tab-pane product-tab-description">
                    <div className="row mt-6">
                        <div className="col-12">
                            <h5 className="description-title mb-4 font-weight-semi-bold ls-m">Características
                            </h5>
                            ...
                            {/*    <tbody>*/}
                            {/*        <tr>*/}
                            {/*            <th className="font-weight-semi-bold text-dark pl-0">Material*/}
                            {/*            </th>*/}
                            {/*            <td className="pl-4">Praesent id enim sit amet.Tdio</td>*/}
                            {/*        </tr>*/}
                            {/*        <tr>*/}
                            {/*            <th className="font-weight-semi-bold text-dark pl-0">Claimed*/}
                            {/*                Size</th>*/}
                            {/*            <td className="pl-4">Praesent id enim sit</td>*/}
                            {/*        </tr>*/}
                            {/*        <tr>*/}
                            {/*            <th className="font-weight-semi-bold text-dark pl-0">Recommended*/}
                            {/*                Use</th>*/}
                            {/*            <td className="pl-4">Praesent id enim sit amet.Tdio vulputate*/}
                        ...
                        {/*            </div>*/}
                        {/*            <div className="icon-box-content">*/}
                        {/*                <h4 className="icon-box-title lh-1 pt-1 ls-s text-normal">Free shipping</h4>*/}
                ...
                {
                    product && product.categories.length || product.brands.length > 0 || colors.length > 0 || sizes.length > 0 ?
