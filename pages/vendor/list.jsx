            ...
            <div className="page-content mb-10 pb-10">
                <div className="container">
                    ...
                    <div className="toolbox">
                        ...
                        <div className="toolbox-right">
                            ...
                            <div className="toolbox-item toolbox-layout">
                                <ALink href="/vendor" className="d-icon-mode-grid btn-layout"></ALink>
                                <ALink href="/vendor/list" className="d-icon-mode-list btn-layout active"></ALink>
                            </div>
                        </div>
                    </div>
                    <Collapse in={ search }>
                    ...
                    <div className="row mt-4 cols-lg-1 cols-sm-2 cols-1">
                        <div className="store-wrap">
                            <div className="store store-list">
                                <div className="store-header">
                                    <figure className="store-banner" style={ { backgroundColor: "#8d9eaa" } }>
                                        <LazyLoadImage
                        ...
                        <div className="store-wrap">
                            <div className="store store-list">
                                <div className="store-header" style={ { backgroundColor: "#ededed" } }>
                        ...
                        <div className="store-wrap">
                            <div className="store store-list">
                                <div className="store-header" style={ { backgroundColor: "#aab0b0" } }>
                                    <figure className="store-banner">
                                        <LazyLoadImage
                        ...
                        <div className="store-wrap">
                            <div className="store store-list">
                                <div className="store-header" style={ { backgroundColor: "#dcc8ad" } }>
                                    <figure className="store-banner">
                                        <LazyLoadImage
                        ...
                        <div className="store-wrap">
                            <div className="store store-list">
                                <div className="store-header" style={ { backgroundColor: "#4e4240" } }>
                                    <figure className="store-banner">
                                        <LazyLoadImage
                        ...
                        <div className="store-wrap">
                            <div className="store store-list">
                                <div className="store-header" style={ { backgroundColor: "#3a4946" } }>
                                    <figure className="store-banner">
                                        <LazyLoadImage
